...
if modal.is_open():
    with modal.container():
        ...
        if booleano [0] == 0:
            st.write ('#### Parabéns, você tem poucas chances de possuir diabetes <br>(Apenas {:.2f}%). Continue cuidando da sua saúde.'.format(100*booleano[1][0] [1]))
        else:
            st.write ('#### Existe uma chance de {:.2f}% de você ser diabético. <br>Recomenda-se procurar um médico.'.format(100*booleano[1][0] [booleano[0][0]]))
